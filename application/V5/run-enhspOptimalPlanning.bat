...
java -jar "%~dp0..\enhsp25.jar" -o %1 -f %2 -planner opt-hrmax -sjr -sp "%~dp0logsPDDL\saved_plan_output_%TIMESTAMP%.txt"
...
::da usare:
::java -jar "%~dp0..\enhsp25.jar" -o %1 -f %2 -planner opt-hrmax -timeout 360 -sjr -sp "%~dp0logsPDDL\saved_plan_output_%TIMESTAMP%.txt"
:: OPT_HMAX OPT_HRMAX
