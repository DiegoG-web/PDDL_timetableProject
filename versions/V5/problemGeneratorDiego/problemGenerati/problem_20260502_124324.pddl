(define (problem problem_20260502_124324) (:domain domainDiegoV5)
...
(= (durataCorso BasiDati) 5)
(insegna Rula BasiDati)
(frequenta Informatica3 BasiDati)

(= (durataCorso linguaggiProgrammazione) 5)
(insegna Lamperti linguaggiProgrammazione)
(frequenta Informatica3 linguaggiProgrammazione)
...
(gruppoStudentiOccupato ITID1 tue08)
