(define (problem problemBrandoV5) (:domain domainBrandoV5)
    ...
    (:init
        ...
        (coppiaCorso sistemiDigitali_1 sistemiDigitali_2)
        (coppiaCorso sistemiDigitali_1 sistemiDigitali_3)
        (coppiaCorso sistemiDigitali_2 sistemiDigitali_3)

        (coppiaCorso analisi_1 analisi_2)
        (coppiaCorso analisi_1 analisi_3)
        (coppiaCorso analisi_2 analisi_3)

        (coppiaCorso componenti_1 componenti_2)
        (coppiaCorso componenti_1 componenti_3)
        (coppiaCorso componenti_1 componenti_4)
        (coppiaCorso componenti_1 componenti_5)
        (coppiaCorso componenti_1 componenti_6)
        (coppiaCorso componenti_1 componenti_7)

        (coppiaCorso componenti_2 componenti_3)
        (coppiaCorso componenti_2 componenti_4)
        (coppiaCorso componenti_2 componenti_5)
        (coppiaCorso componenti_2 componenti_6)
        (coppiaCorso componenti_2 componenti_7)

        (coppiaCorso componenti_3 componenti_4)
        (coppiaCorso componenti_3 componenti_5)
        (coppiaCorso componenti_3 componenti_6)
        (coppiaCorso componenti_3 componenti_7)

        (coppiaCorso componenti_4 componenti_5)
        (coppiaCorso componenti_4 componenti_6)
        (coppiaCorso componenti_4 componenti_7)

        (coppiaCorso componenti_5 componenti_6)
        (coppiaCorso componenti_5 componenti_7)

        (coppiaCorso componenti_6 componenti_7)
